                              ...
                              <div class="col-sm-3">
                                    <div class="input-group control-group">
                                      <select class="form-control" name="pinjam" id="pinjam">
                                        ...
                                        $query    =mysql_query("SELECT * FROM inventaris WHERE dipinjamkan='YA'");
                                        while ($data = mysql_fetch_array($query)) {
                                        ?>
                                        <option value="(<?php echo $data['kd_alat'];?>)<?php echo $data['nama_alat'];?>">(<?php echo $data['kd_alat'];?>)<?php echo $data['nama_alat'];?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
