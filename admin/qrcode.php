                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    ...
                                    <input type="submit" name="print" id="print" value="Print" class="btn btn-sm btn-success pull-right" onclick="printContent('qrcode')"/>
                                </header>
                                <?php
//library phpqrcode
...
?>
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id_alat" type="text" id="id_alat" class="form-control" placeholder="Tidak perlu di isi" value="<?php echo $data['id_alat']; ?>" autofocus="on" readonly="readonly" />
                              </div>
                              <input type="submit" name="generate" id="generate" value="Generate" class="btn btn-sm btn-primary" onclick="" />
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Alat</label>
                              <div class="col-sm-8">
                                  <input name="nama_alat" type="text" id="nama_alat" class="form-control" placeholder="Nama Alat" value="<?php echo $data['nama_alat']; ?>" readonly="readonly" />
                              </div>
                              <input type="button" name="kembali" value="Kembali" class="btn btn-sm btn-danger" onclick="history.go(-1);"> </a>
                          </div>
        ...
        if (isset($_POST['generate'])) {
            $nama_alat=stripslashes($_POST['nama_alat']);
            $teks = stripslashes($_POST['id_alat']);
            echo "<pre>Nama Alat : <b>$nama_alat</b></p>";
            ...
            echo "<img src='qrcode/$namafile' width='200px'>";
            echo "<p><b>SMK NU Ma'arif 2 Kudus</b></p>";
        }
    ?></div></div></center>
...
function printContent(el){
    ...
    window.print();
    window.location.replace("qrcode.php?hal=edit&kd=<?php echo $data['id_alat'];?>");
}
</script>
</body>
</html>