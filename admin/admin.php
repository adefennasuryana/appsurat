...
<?php } ?>
                ...
                <section class="content" style="height: 575px;">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="admin.php" method="POST">
                                        <div class="input-group">
                                        <input type='text' class="form-control input-sm pull-right" style="width: 150px;"  name='qcari' placeholder='Cari Username' required /> 
                  ...
                  <thead>
                    ...
                    <tbody>
                    <tr>
                    <td><center><?php echo $noUrut; $noUrut++; ?></center></td>
                    ...
                    <td><center><img src="<?php echo $data['gambar']; ?>" class="img-square" height="80" width="75" style="border: 3px solid #333333;" /></center></td>
