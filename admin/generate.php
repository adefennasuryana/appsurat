...
?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id_alat" type="text" id="id_alat" class="form-control" required />
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nama_alat" type="text" id="nama_alat" class="form-control" required />
                              </div>
...
function printContent(el){
    ...
    window.print();
    window.location.replace("generate.php?hal=edit&kd=<?php echo $data['id_alat'];?>");
}
</script>
</body>
</html>