...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Input Inventaris Habis Pakai</b>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-habispakai.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="jumlah" class="form-control" id="jumlah" onkeyup="sum()" type="text" placeholder="Jumlah" required />
                              </div>
                          </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kategori</label>
                                  <div class="col-sm-6">
                                  <input class="form-control" name="kategori" id="kategori" readonly value="Habis Pakai">
                          </div>
						  </div>
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="habis_pakai.php" class="btn btn-sm btn-danger">Reset </a>
								  <a href="habis_pakai.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
