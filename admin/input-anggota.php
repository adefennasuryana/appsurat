                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Input Inventaris Tak Habis Pakai</b>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <input class="form-control" type="hidden" name="kategori" id="kategori" readonly value="Tak Habis Pakai" required />
                                  <input class="form-control" type="hidden" name="tampilkan" id="tampilkan" readonly value="DISEMBUNYIKAN" required />
                          <div class="form-group" style="margin-bottom: 20px;">
                              <label class="col-sm-2 col-sm-2 control-label"></label>
                              <div class="col-sm-8">
                                  <input type="submit" value="Simpan" class="btn btn-sm btn-primary" />&nbsp;
	                              <a href="input-anggota.php" class="btn btn-sm btn-danger">Reset </a>
