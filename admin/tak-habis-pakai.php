                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
									<form action="tak-habis-pakai.php" method="POST">
                                        <b>Data Inventaris Tak Habis Pakai</b>
                                ...
                                <div class="panel-body table-responsive">
                                    <div class="box-tools m-b-15">
										<div class="button">
										<a href="tak-habis-pakai.php" class="btn btn-sm btn-info">Refresh Inventaris <i class="fa fa-refresh"></i></a> <a href="input-inventaris.php" class="btn btn-sm btn-info">Tambah Inventaris <i class="fa fa-arrow-circle-right"></i></a>
										</div>									
                                    </div>
                                    <?php
...
if (!file_exists($tempdir))
    mkdir($tempdir);
                    $query1="select * from inventaris where kategori='Tak Habis Pakai'";
...
while($data=mysql_fetch_array($result)) {
    ...
    if (!file_exists($pngAbsoluteFilePath)) {
        QRcode::png($qrvalue,$pngAbsoluteFilePath,$quality,$ukuran,$padding);
	               ...
	               where kategori='Tak Habis Pakai'
	               AND nama_alat like '%$qcari%'";
                    }
              ...
              ?>
                  ...
                  <?php $tampil=mysql_query("select * from inventaris where kategori='Tak Habis Pakai'");
                    ...
                    ?>
                  <center><h4>Jumlah Inventaris Tak Habis Pakai : <?php echo "$jumlah"; ?> Unit </h4> </center>
