...
<?php } ?>
                ...
                <div class="col-md-12">
                            <section class="panel">
                              <header class="panel-heading">
                                <b>  Data Akumulasi Peminjam</b>
                            </header>
                            <div class="panel-body table-responsive">
                            <?php
                    $query="select * from pinjam,kembali1 where pinjam.id = kembali1.id";
              ...
              ?>
                  ...
                  <?php $tampil1=mysql_query("select * from pinjam order by id");
