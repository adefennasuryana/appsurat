...
<div class="col-md-12" id="QR-Code">
            <div class="panel panel-primary">
                ...
                <div class="panel-body text-center" id="noti-box">
                    <div class="col-md-16">
...
<script type="text/javascript">
    var arg = {
        resultFunction: function(result) {
            //$('.hasilscan').append($('<input name="idalat" id="idalat" value=' + result.code + ' readonly><input type="submit" value="Cek"/>'));
           // $.post("cek.php", { idalat: result.code} );
            var redirect = 'cek.php';
            $.redirectPost(redirect, {idalat: result.code});
        }
    };
